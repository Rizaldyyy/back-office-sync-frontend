...
const Table = (props: TableProps) => {
    ...
    const sizePerPageList = props['sizePerPageList'] || defaultSizePerPageList;
    ...
    const dataTable = useTable(
        {
            ...
            data: props['data'],
            initialState: { pageSize: props['pageSize'] || 25 },
        },
                        ...
                        Cell: ({ row }) =>
                            ...
                            row.canExpand ? (
                                <span
                                    ...
                                    {row.isExpanded ? <FeatherIcon icon="minus-circle" className="icon-dual"/> : <FeatherIcon icon="plus-circle" className="icon-dual"/>}
                                </span>
                            ) : null,
                    },
                    ...columns,
                    ...
                    <tbody {...dataTable.getTableBodyProps()}>
                        {(rows || []).map((row: any, i: number) => {
                            ...
                            return (
                                <tr {...row.getRowProps()}>
                                    <td>
                                        { parseFloat(row.id) + 1 }  {/* default value for the default column */}
                                    </td>
